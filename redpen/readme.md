...
> **Note:** Это расширение работает локально (DOM-манипуляции). Правки автоматически сохраняются и восстанавливаются после перезагрузки страницы!
...
*   **Постоянное сохранение:** Все правки автоматически сохраняются в локальном хранилище Chrome и восстанавливаются после перезагрузки страницы.
